...
- Sample: six real game-night catalogue entries, including passed and in-progress QA states.
...
- Regression: `npm run test:browser -- --grep @claim:demo-sandbox` starts a fresh phone context. It changes and resets the sample, checks the label, exits, and verifies storage and request origins.
